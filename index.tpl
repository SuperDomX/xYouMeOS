...
<!-- 				<img src="images/icons/sound-on.svg" alt="" /> -->
		...
		<script src="{$_DIR}js/dat.gui.min.js"></script>
		<script src="{$_DIR}js/three.min.js"></script>
		<script src="{$_DIR}js/tween.js"></script>
		<script src="{$_DIR}js/Detector.js"></script>
		<script src="{$_DIR}js/THREEx.KeyboardState.js"></script>
		<script src="{$_DIR}js/THREEx.WindowResize.js"></script>
		<script src="{$_DIR}js/jquery-1.7.1.min.js"></script>
		<script src="{$_DIR}js/underscore.js"></script>
		<script src="{$_DIR}js/jquery.mousewheel.js"></script>
		<script src="{$_DIR}js/jquery.preventMacBackScroll.js"></script>

		<script src="{$_DIR}js/util.js"></script>
		<script src="{$_DIR}js/mousekeyboard.js"></script>
		<script src="{$_DIR}js/urlArgs.js"></script>
		...
		<script src="{$_DIR}js/jquery-ui.min.js"></script> <!-- jQuery UI -->
        

		<script src="{$_DIR}js/director.js" type="text/javascript"></script>
		<script src="{$_DIR}js/infocallout.js" type="text/javascript"></script>
		<script src="{$_DIR}js/starsystems.js" type="text/javascript"></script>
		<script src="{$_DIR}js/starmodel.js" type="text/javascript"></script>
		<script src="{$_DIR}js/css3worldspace.js" type="text/javascript"></script>
		<script src="{$_DIR}js/helphud.js" type="text/javascript"></script>
		<script src="{$_DIR}js/spacehelpers.js" type="text/javascript"></script>
		<script src="{$_DIR}js/shaderlist.js" type="text/javascript"></script>
		<script src="{$_DIR}js/skybox.js" type="text/javascript"></script>
		<script src="{$_DIR}js/plane.js" type="text/javascript"></script>
		<script src="{$_DIR}js/guides.js" type="text/javascript"></script>
		<script src="{$_DIR}js/dust.js" type="text/javascript"></script>
		<script src="{$_DIR}js/lensflare.js" type="text/javascript"></script>
		<script src="{$_DIR}js/hipparcos.js" type="text/javascript"></script>
		<script src="{$_DIR}js/galaxy.js" type="text/javascript"></script>
		<script src="{$_DIR}js/solarsystem.js" type="text/javascript"></script>
		<script src="{$_DIR}js/sun.js" type="text/javascript"></script>
		<script src="{$_DIR}js/legacymarkers.js" type="text/javascript"></script>
		<script src="{$_DIR}js/marker.js" type="text/javascript"></script>
		<script src="{$_DIR}js/tour.js" type="text/javascript"></script>
		<script src="{$_DIR}js/main.js" type="text/javascript"></script>

		<!-- Post main loading scripts -->
		<script src="{$_DIR}js/jquery.tooltip.js" type="text/javascript"></script>
		<script src="{$_DIR}js/minimap.js" type="text/javascript"></script>
